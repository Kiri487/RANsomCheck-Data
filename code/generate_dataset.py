...
np.savez('./final_dataset_train.npz', x_name = dataset_train['x_name'], x_semantic = dataset_train['x_semantic'], y = dataset_train['y'])
np.savez('./final_dataset_test.npz', x_name = dataset_test['x_name'], x_semantic = dataset_test['x_semantic'], y = dataset_test['y'])
...
total_goodware_count = train_goodware_count + test_goodware_count
total_ransomware_count = train_ransomware_count + test_ransomware_count
