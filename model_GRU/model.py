...
from torch.nn import Embedding, Conv1d, GRU, Linear, BCELoss, Conv2d, ZeroPad2d
...
train_data = np.load('../dataset/dataset_demo_train.npz', allow_pickle=True)
train_x_name = train_data['x_name']
train_x_semantic = train_data['x_semantic']
train_y = train_data['y']

test_data = np.load('../dataset/dataset_demo_test.npz', allow_pickle=True)
...
torch.save(model, './model_demo.pkl')
